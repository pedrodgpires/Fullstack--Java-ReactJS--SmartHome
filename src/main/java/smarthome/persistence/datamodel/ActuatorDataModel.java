...
public class ActuatorDataModel {
    ...
    public ActuatorDataModel(Actuator actuator) {
        ...
        if (actuator instanceof ActuatorOfDecimalLimiter) {
            ...
            this.precision = ((ActuatorOfDecimalLimiter) actuator).getPrecision().getPrecision();
        }
    ...
    /**
     * Returns the precision of the decimal limits for this actuator, if applicable.
     *
     * @return the precision of decimal limits.
     */
